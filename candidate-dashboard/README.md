...
| `src/pauseTracking.js` | Persisted (`<DATA_DIR>/training-pause-tracking.json`) "paused since" timestamp per pool+trainee, since Ashby has none of its own — see § Interviewer Training above. |
